          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center max-w-6xl mx-auto">
            ...
            <Reveal delay={120}>
              <div className="relative mx-auto max-w-md md:max-w-none">
                ...
                />
                {/* Native ~3:2 landscape — placed as-is, no crop. */}
                <div className="relative overflow-hidden rounded-[2rem] aspect-[3/2] bg-secondary-light shadow-2xl shadow-primary/15 ring-1 ring-white/40">
                  <Image
                    src="/images/about-coastal.jpg"
                    alt="Person walking on a tree-lined path in soft daylight, with the ocean in the distance"
                    fill
